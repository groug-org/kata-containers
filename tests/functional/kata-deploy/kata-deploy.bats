...
setup() {
	...
	sed -i -e "s|quay.io/kata-containers/kata-deploy:3.3.0|${DOCKER_REGISTRY}/${DOCKER_REPO}:${DOCKER_TAG}|g" "${repo_root_dir}/tools/packaging/kata-deploy/kata-deploy/base/kata-deploy.yaml"
...
teardown() {
	...
	sed -i -e "s|quay.io/kata-containers/kata-deploy:3.3.0|${DOCKER_REGISTRY}/${DOCKER_REPO}:${DOCKER_TAG}|g" "${repo_root_dir}/tools/packaging/kata-deploy/kata-cleanup/base/kata-cleanup.yaml"
